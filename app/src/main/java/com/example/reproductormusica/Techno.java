...
public class Techno extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        play_pause = (Button)findViewById(R.id.btnPlay3);
        btn_repetir = (Button)findViewById(R.id.btnRepetir3);
        iv = (ImageView)findViewById(R.id.imageView);

        vectormp[0] = MediaPlayer.create(this,R.raw.music11);
        vectormp[1] = MediaPlayer.create(this,R.raw.music12);
